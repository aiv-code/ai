        ...
        try:
            ...
            if schema_name and schema_name != "public":
                with self._connection.cursor() as cursor:
                    ...
                    logger.info(f"[RedshiftConnector] Connected and set search_path to: {actual_path}")
    ...
    def execute_query(self, query: str, timeout: int = 300) -> List[Dict[str, Any]]:
        ...
        try:
            ...
            with self._connection.cursor(cursor_factory=RealDictCursor) as cursor:
                # Set statement timeout (Redshift uses milliseconds)
            ...
            logger.error(f"[RedshiftConnector] Query execution failed: {str(e)}")
